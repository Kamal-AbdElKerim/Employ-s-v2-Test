            ...
            <c:forEach var="offre" items="${offres}">
                ...
                <div class="OnePost">
                    ...
                    <div class="profile">
                        ...
                        <div class="moreinfo">
                            <c:if test="${offre.statut eq 'FERME'}">
                                <button class="button-33 disabled" type="button">Join Candidatures</button>
                            </c:if>
                            <c:if test="${offre.statut eq 'ACTIVE'}">
                                <a class="button-33 "  href="candidature?id=${offre.offreId}">Join Candidatures</a>
                            </c:if>
                        </div>
